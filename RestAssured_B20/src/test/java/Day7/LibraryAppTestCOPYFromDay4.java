...
public class LibraryAppTestCOPYFromDay4 {
...
//      this is how we provide header .header("headerName","headerValue")
    ...
    @DisplayName("4. Save /get_book_categories as POJO")
    @Test
    public void testGetBookCategoriesAsPojo(){
       ...
       JsonPath jp = given()
        ...
        // without using above list, use jsonPath to get number 5 item in jsonArray
        //and save it as BookCategory object

        BookCategory number5BookCategory = jp.getObject("[4]", BookCategory.class);
        System.out.println("number5BookCategory = " + number5BookCategory);
